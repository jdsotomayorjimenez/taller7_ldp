...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Interes>|Interes whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Interes>|Interes whereNombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Interes>|Interes whereDescripcion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Interes>|Interes whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Interes>|Interes whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Interes>|Interes newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Interes>|Interes newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Interes>|Interes query()
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Interes>|Interes timeout(int $seconds)
     ...
     */
    class Interes extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property string $nombre
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Interes> $intereses
     * @property-read int|null $intereses_count
     * @method static \Illuminate\Database\Eloquent\Builder<Persona>|Persona whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Persona>|Persona whereNombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Persona>|Persona whereEmail($value)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<Persona>|Persona timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
